...
dvdColors :: [FilePath]
dvdColors = ["app/logos/04dvdlogo-red.png", "app/logos/09dvdlogo-lightblue.png", "app/logos/02dvdlogo-green.png", "app/logos/03dvdlogo-pink.png",
 "app/logos/05dvdlogo-yellow.png", "app/logos/01dvdlogo-purple.png", "app/logos/08dvdlogo-orange.png", "app/logos/07dvdlogo-darkblue.png"]
...
changeDir s = do
  ...
  let (width, height) = s
  let vx' =
        if withinBounds x width logoW
          then -- update the velocity
            -vx
          else vx
  let vy' =
        if withinBounds y height logoH
          then -- update the velocity
            -vy
          else vy
